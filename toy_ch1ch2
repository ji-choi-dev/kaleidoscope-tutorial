...
static int gettok() {
  static int LastChar = ' '; //function scope, but static lifetime - not reassigned upon continuous function calls.
  ...
  if (isdigit(LastChar) || LastChar == '.') { // Number: [0-9.]+
    ...
    NumVal = strtod(NumStr.c_str(), nullptr); //technically not ideal because 1.3.4 which is not a number is also legal
    return tok_number;
  }
  ...
  // Otherwise, just return the character as its ascii value. chars like "+" "-"
